...
\newcommand{\entry}[4]
{\textbf{#1}\ \SG{#1}\ {/\textipa{#2}/}\ \textit{#3}\ $\bullet$\ {#4}}
...
\include{02_Typology}
\include{03_Phonology}
\include{04_Grammar/04_Grammar}
\include{05_Quantifiers}
\include{06_Lexicon/06_Lexicon}
\include{07_Translations}
