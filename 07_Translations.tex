...
\ex~[glstyle=nlevel]
\begingl
\glpreamble \SG{sini\.{z}esba\v{z}odi\v{z}ojem\v{s}aki\v{s}i} \\ sini\.{z}esba\v{z}o di\v{z}ojem \v{s}aki\v{s}i
\endpreamble
s-[{\Ind}-]@
ini-[{\Hab}-]@
\.{z}e[give]@
...
\ex~[glstyle=nlevel]
\begingl
\glpreamble \SG{yeku\v{z}udesecisbi\v{z}ajañeke} \\ yeku\v{z}u dese cisbi\v{z}a jañeke
\endpreamble
y-[{\Subj}-]@
e-[{\Pfv}-]@
ku[go]@
